...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              <a class="nav-link active" aria-current="page" href="adminLogin">Home</a>
    ...
    <div class="content">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Selamat Bertugas Petugas</h5>
          <a href="login" class="btn btn-primary">Tugas</a>
        </div>
      </div>
    </div>
      @yield('isi')
